 ...
 * Roll the die for the user (generate a Random number between 1 – 6) and advance the user that number of spaces on* the game board. Here’s the code to do this ((import is java.util.Random):*                   Random*
 *
